...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      // Get quiz session ID from localStorage if exists
      ...
      <div className="flex-1 flex flex-col items-center px-6 py-12 md:py-16">
        <div className="w-full max-w-[420px]">
          ...
          <p className="mt-4 text-[16px] leading-[24px] text-white/90">
            Sign up to get your personalized workout plan.
          </p>
          ...
          <form onSubmit={handleSignUp} className="mt-8">
            ...
            {success && (
              <div className="mt-4 p-3 rounded-md bg-green-500/20 text-green-200 text-sm">
            ...
            <button
              ...
              style={{
                backgroundColor: email && !isLoading ? ORANGE : '#3a2015',
                color: email && !isLoading ? 'white' : 'rgba(255, 255, 255, 0.4)',
                border: 'none',
